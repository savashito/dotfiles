...
;^j::
;Send, My First Script this is Rocamora
;return
...
F1:: BS.SetBrightness(-10)
F2:: BS.SetBrightness(10)

; ^j::BS.SetBrightness(-10)
; ^k::BS.SetBrightness(10)
...
; LAlt & c::Send, {CTRLDOWN}{Ins}{CTRLUP}
; LAlt & v::Send, {SHIFTDOWN}{Ins}{SHIFTUP}
